...
search.addEventListener('click', ()=>{
    const APIKey='4f516433032f9127e3568c73bcdf598b';
    ...
    (json =>{
        if(json.cod === '404'){
            ...
            weatherDetalis.style.display='none';
        ...
        const uvIndex=document.querySelector('.weather-detalis .UV span');
        ...
        uvIndex.innerHTML=`${json.main.humidity}`;
        
        


        weatherBox.style.display='';
        weatherDetalis.style.display='';
        weatherBox.classList.add('fadeIn');
        weatherDetalis.classList.add('fadeIn');
